    ...
    for ii in situation_list:
        for iii in count_list:
            for iiii in sentence_list:
                video_list.append(cv2.VideoWriter("/Users/yamauchisachiyo/Downloads/{}_{}_{}_{}.mp4".format(i,ii,iii,iiii), fourcc, fps, (w, h)))  # 動画の仕様（ファイル名、fourcc, FPS, サイズ）
...
def recording_movie():
    ...
    while True:
        ...
        video_list[count].write(bitwise) 
